declare namespace TavernHelper {
    type Audio = {
        /** 标题 */
        title: string;
        /** 音频的网络链接 */
     ...
     */
    declare function setAudioSettings(
        type: 'bgm' | 'ambient',
    ...
    declare function getChatMessages(
        range: string | number,
        {
            ...
            hide_state,
            include_swipes,
        }?: Omit<GetChatMessagesOption, 'include_swipes'> & {
    ...
    declare function deleteChatMessages(
        message_ids: number[],
        { refresh }?: DeleteChatMessagesOption
    ): Promise<void>;
     ...
     */
    declare function retrieveDisplayedMessage(
        message_id: number
     ...
     */
    declare function getExtensionType(
        extension_id: string
     ...
     * }
     */
    declare function uninstallExtension(
        extension_id: string
    ): Promise<Response>;
     ...
     * }
     */
    declare function reinstallExtension(
        extension_id: string
    ): Promise<Response>;
     ...
     */
    declare function importRawCharacter(
        filename: string,
        content: Blob
    ): Promise<Response>;
     ...
     */
    declare function importRawChat(
        filename: string,
        content: string
    ): Promise<Response>;
     ...
     */
    declare function importRawPreset(
        filename: string,
        content: string
    ): Promise<Response>;
     ...
     */
    declare function importRawWorldbook(
        filename: string,
        content: string
    ): Promise<Response>;
     ...
     */
    declare function importRawTavernRegex(
        filename: string,
        content: string
    ): boolean;
    interface Window {
    ...
    /** @deprecated 请使用内置库 "世界书强制用推荐的全局设置" */
    declare function setLorebookSettings(
    ...
    /** @deprecated 请使用 `getCharWorldbookNames` */
    declare function getCharLorebooks({
        name,
        type,
    ...
    declare function setCurrentCharLorebooks(
    ...
    declare function getOrCreateChatLorebook(
        lorebook?: string
    ): Promise<string>;
    ...
    /** @deprecated 请使用 `getWorldbook` */
    declare function getLorebookEntries(
        lorebook: string
    ...
    type PresetSystemPrompt = SetRequired<
        { id: 'main' | 'nsfw' | 'jailbreak' | 'enhanceDefinitions' } & Omit<
            PresetPrompt,
            'id'
        >,
        'content'
    ...
    type PresetPlaceholderPrompt = SetRequired<
        ...
        'position'
    >;
    declare function isPresetNormalPrompt(
        prompt: PresetPrompt
    ): prompt is PresetNormalPrompt;
    declare function isPresetSystemPrompt(
        prompt: PresetPrompt
    ): prompt is PresetSystemPrompt;
    declare function isPresetPlaceholderPrompt(
        prompt: PresetPrompt
    ): prompt is PresetPlaceholderPrompt;
     ...
     * @returns 角色头像路径
     */
    declare function getCharAvatarPath(
        name: LiteralUnion<'current', string>,
        allowAvatar?: boolean
    ): string | null;
     ...
     */
    declare function getTavernRegexes({
        scope,
        enable_state,
    }?: GetTavernRegexesOption): TavernRegex[];
    ...
    type WorldbookUpdater =
        ...
        | ((
              worldbook: WorldbookEntry[]
          ) => Promise<PartialDeep<WorldbookEntry>[]>);
    /**
    ...
    declare function deleteWorldbookEntries(
        ...
        worldbook: WorldbookEntry[];
        deleted_entries: WorldbookEntry[];
    }>;
    ...
    declare function eventOnButton<T extends EventType>(
        event_type: T,
        listener: ListenerType[T]
    ): void;
    ...
    interface ListenerType {
        ...
        [tavern_events.WORLDINFO_UPDATED]: (
            name: string,
            data: {
                entries: { [uid: number]: SillyTavern.FlattenedWorldInfoEntry };
            }
        ) => void;
        ...
        [tavern_events.WORLDINFO_ENTRIES_LOADED]: (lores: {
            globalLore: ({
                world: string;
            } & SillyTavern.FlattenedWorldInfoEntry)[];
            characterLore: ({
                world: string;
            } & SillyTavern.FlattenedWorldInfoEntry)[];
            chatLore: ({
        ...
        [tavern_events.PRESET_CHANGED]: (data: {
            apiId: string;
            name: string;
        }) => void;
        [tavern_events.PRESET_DELETED]: (data: {
            apiId: string;
            name: string;
        }) => void;
    ...
    declare namespace Mvu {
        ...
        type SetCommandInfo = {
            ...
            args:
                ...
                | [
                      path: string,
                      expected_old_value_literal: string,
                      new_value_literal: string,
                  ];
            reason: string;
        };
        ...
        type DeleteCommandInfo = {
            ...
            args:
                | [path: string]
                | [path: string, index_or_key_or_value_literal: string];
            reason: string;
        };
        type AddCommandInfo = {
            type: 'remove';
    ...
    declare const Mvu: {
        ...
        setMvuVariable: (
            ...
            new_value: any,
            {
                reason,
                is_recursive,
            }?: { reason?: string; is_recursive?: boolean }
        ) => Promise<boolean>;
    ...
    declare namespace SillyTavern {
        type ChatMessage = {
            ...
            variables?:
                | Record<string, any>[]
                | { [swipe_id: number]: Record<string, any> };
            extra?: Record<string, any>;
        };
        ...
        type PopupOptions = {
            ...
            onClosing?: (
                popup: InstanceType<typeof SillyTavern.Popup>
    ...
    declare const SillyTavern: {
        ...
        readonly sendStreamingRequest: (
            type: string,
            data: object
        ) => Promise<void>;
        readonly sendGenerationRequest: (
            type: string,
            data: object
        ) => Promise<void>;
        readonly stopGeneration: () => boolean;
        readonly tokenizers: any;
        readonly getTextTokens: (
            tokenizer_type: number,
            string: string
        ) => Promise<number>;
        readonly getTokenCountAsync: (
            string: string,
        ...
        readonly saveWorldInfo: (
            name: string,
            data: any,
            immediately?: boolean
        ) => Promise<void>;
        /** reloadEditor */
        readonly reloadWorldInfoEditor: (
            file: string,
            loadIfNotSelected?: boolean
        ) => void;
        ...
        readonly extractMessageFromData: (
            data: object,
            activateApi?: string
        ) => string;
     ...
     */
    declare function initializeGlobal(
        global: LiteralUnion<'Mvu', string>,
        value: any
    ): void;
     ...
     * ...此后可以直接使用 Mvu 接口
     */
    declare function waitGlobalInitialized<T>(
        global: LiteralUnion<'Mvu', string>
    ): Promise<T>;
    /**
     ...
     */
    declare function appendInexistentScriptButtons(
